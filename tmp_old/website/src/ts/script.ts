...
function downloadPack() {
    ...
    const url = process.env["NODE_ENV"] !== 'production' ? "http://localhost:8888/.netlify/functions/makePack" : "https://us-central1-faithfultweaks-app.cloudfunctions.net/makePack"; // URL (based on node environment status)
    const data = {
        "format": version,
        "modules": modules,
